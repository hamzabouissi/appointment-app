...
SECRET_KEY = "django-insecure-_skrv5wcj9p1vga7*&axq&j9$hcd6v)9%z1!d+6zpxa1d=anr-"
...
XRAY_RECORDER = {
    ...
    'SAMPLING': True,
    'SAMPLING_RULES': None,
    'AWS_XRAY_TRACING_NAME': "DjangoAppV2", # the segment name for segments generated from incoming requests
